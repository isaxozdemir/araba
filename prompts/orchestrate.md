...
**Skor eşikleri:** 75–100 → AL · 60–74 → BAKILABİLİR · 45–59 → PAS GEÇ · 0–44 → KAÇIN.  
Her kategori içinde `score` büyükten küçüğe sıralanır; `status: "removed"` olanlar en alta eklenir.
